...
urlpatterns = [
    ...
    path('events/<str:slug>/attendances', GetAttendancesByEventIdView.as_view() , name='get-attendances-by-event-id'),
    ...
    path('events/<str:slug>/attenders', GetEventAttenders.as_view() , name='get-attenders-by-event-id'),
    ...
    path('events/<str:slug>/stadistics', GetEventAttendanceStadisticsView.as_view() , name='get-event-stadistics-by-event-id'),
]